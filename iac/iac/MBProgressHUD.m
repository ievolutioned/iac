...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
        self.color = nil;
		self.labelFont = [UIFont fontWithName:@"RobotoSlab-Light" size:kLabelFontSize];
		self.detailsLabelFont = [UIFont fontWithName:@"RobotoSlab-Light" size:kDetailsLabelFontSize];
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
